...
if conf.AUTOCREATE_DB:
    @receiver(pre_migrate, sender=apps.get_app_config('apps.management'))
...
class Registered_user(models.Model):
    ...
    status = models.CharField(max_length=20,choices=CHOICES,default="Deactivate")
    date_joined = models.DateTimeField(auto_now_add=True)

    class Meta:
        ordering = ['username', 'last_login', 'status','date_joined']
